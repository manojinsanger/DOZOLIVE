...
const SeatLayout = ({ room, roomId, userId, changeSeat, handleToggleMic, handleKickUser, handleChangeSeat }:{room:any,roomId:any,userId:any,changeSeat:any,handleToggleMic:any,handleKickUser:any,handleChangeSeat:any}) => {
