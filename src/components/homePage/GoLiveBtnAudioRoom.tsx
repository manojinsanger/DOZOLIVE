  ...
  return (
    ...
    >
      <LinearGradient
        ...
        locations={[0, 1]}
        style={{display:'flex',flexDirection:'row',gap:5,padding:10}}
      >
        ...
        <Text style={styles.buttonText}>Launch Party</Text>
      </LinearGradient>
    </TouchableOpacity>
  );
};
...
export default GoLiveBtnAudioRoom;
