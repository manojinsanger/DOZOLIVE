        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView style={styles.scrollView}>
                ...
                <View style={styles.exchangeOptionsContainer}>
                    {exchangeOptions.map((option, index) => (
                        <TouchableOpacity
                            ...
                            style={[
                                ...
                                option.selected && !isCustomize ? styles.selectedOption : styles.unselectedOption,
                            ]}
                            onPress={() => {
                                selectOption(index)
                                setCustomize(false)
                    ...
                    <TouchableOpacity onPress={() => setCustomize(true)} style={[styles.customizeButton, isCustomize && styles.selectedOption, styles.exchangeOption, { height: 80, flexDirection: 'row', justifyContent: 'center', alignItems: "center" }]}>
                ...
                {/* Verification Code */}
                {
                    isCustomize && <><Text style={styles.sectionTitle}>Exchange Quantity</Text><View style={styles.amountInputContainer}>
                        <TextInput
                        ...
                        <Text>X</Text>
                        <View style={styles.pointsIconContainer}>
                            <Image style={[styles.points, {marginRight: -16}]} source={beanIcon} />
                        </View>
                        <Text> 100,1000</Text>
