...
//   const { room, joinRoom, leaveRoom, requestCohost, changeSeat, assignCohostAndSeat } = useAudioRoom();
...
//   const { params } = useRoute();
//   const { userAllDetails } = useUser();
//   const { room, joinRoom, leaveRoom, requestCohost, changeSeat, assignCohostAndSeat, removeCohostStatus } = useAudioRoom();
